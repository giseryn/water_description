...
if __name__ == '__main__':
    ...
    try_different_method(model_LinearRegression,"model_linearRegressionModel")
    RF=joblib.load("../resultData/machineLearningModel/model_linearRegressionModel.model")
    ...
    new_tiff_name='../resultData/computingResult/LinearResult.tif'
